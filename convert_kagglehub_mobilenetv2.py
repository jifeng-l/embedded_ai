...
print("✅ Saved float32 model:", fp32_path)

# === 4. Representative dataset for quantization ===
...
print("✅ Saved int8 quantized model:", int8_path)

# === 6. Final message ===
print("\n🎯 Conversion complete. Use edgetpu_compiler on the INT8 model:")
